...
public final class SipHeaderNames {
     ...
     * {@code "Subject"}
     */
    public static final AsciiString SUBJECT = AsciiString.cached("Subject");
     ...
     * {@code "Event"}
     */
    public static final AsciiString EVENT = AsciiString.cached("Event");

    /**
     * {@code "Support"}
     */
    public static final AsciiString SUPPORT = AsciiString.cached("Support");
